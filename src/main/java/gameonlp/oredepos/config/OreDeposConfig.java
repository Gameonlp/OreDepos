...
public class OreDeposConfig {
    public static class Common {
        ...
        public Common(ForgeConfigSpec.Builder builder) {
            ...
            coal = new OreConfig(builder, "coal", false, true, true, 1.0f, 17, 1, 128, 20);
            iron = new OreConfig(builder, "iron", false, true, true, 1.0f, 9, 1, 68, 20);
            redstone = new OreConfig(builder, "redstone", false, true, true, 1.0f, 8, 1, 16, 8);
            gold = new OreConfig(builder, "gold", false, true, true, 1.0f, 9, 1, 30, 5);
            lapis = new OreConfig(builder, "lapis", false, true, true, 1.0f, 7, 1, 34, 2);
            diamond = new OreConfig(builder, "diamond", false, true, true, 1.0f, 8, 1, 16, 1);
            emerald = new OreConfig(builder, "emerald", false, true, true, 1.0f, 1, 1, 33, 1);
            tin = new OreConfig(builder, "tin", true, true, true, 1.0f, 9, 1, 68, 20);
            copper = new OreConfig(builder, "copper", true, true, true, 1.0f, 9, 1, 68, 20);
            lead = new OreConfig(builder, "lead", true, true, true, 1.0f, 6, 1, 35, 8);
            silver = new OreConfig(builder, "silver", true, true, true, 1.0f, 6, 1, 35, 8);
            aluminum = new OreConfig(builder, "aluminum", true, true, true, 1.0f, 6, 1, 64, 12);
            builder.pop();
            builder.pop();
        }
    }

...
public class GrinderRecipeBuilder implements RecipeBuilder {
    ...
    public GrinderRecipeBuilder condition(Condition condition) {
    ...
    public void save(Consumer<FinishedRecipe> p_126205_, ResourceLocation p_126206_) {
        ...
        p_126205_.accept(new GrinderRecipeBuilder.Result(p_126206_, this.result, this.count, this.condition, this.group == null ? "" : this.group, this.ingredient, this.energy, this.ticks, this.advancement, new ResourceLocation(p_126206_.getNamespace(), "recipes/" + this.result.getItemCategory().getRecipeFolderName() + "/" + p_126206_.getPath())));
    }

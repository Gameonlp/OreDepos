...
public class GrinderRecipeBuilder implements RecipeBuilder {
    ...
    public GrinderRecipeBuilder ticks(int ticks) {
        this.ticks = ticks;
        return this;
    }

    public GrinderRecipeBuilder unlockedBy(String p_126197_, CriterionTriggerInstance p_126198_) {
        this.advancement.addCriterion(p_126197_, p_126198_);
        return this;
    }

    public GrinderRecipeBuilder group(@Nullable String p_126195_) {
    ...
    public void save(Consumer<FinishedRecipe> p_126205_, ResourceLocation p_126206_) {
        ...
        p_126205_.accept(new GrinderRecipeBuilder.Result(p_126206_, this.result, this.count, this.group == null ? "" : this.group, this.ingredient, this.energy, this.ticks, this.advancement, new ResourceLocation(p_126206_.getNamespace(), "recipes/" + this.result.getItemCategory().getRecipeFolderName() + "/" + p_126206_.getPath())));
    }
    ...
    public static class Result implements FinishedRecipe {
        ...
        public Result(ResourceLocation resourceLocation, Item item, int count, String group, Ingredient ingredient, int energy, int ticks, Advancement.Builder p_126227_, ResourceLocation p_126228_) {

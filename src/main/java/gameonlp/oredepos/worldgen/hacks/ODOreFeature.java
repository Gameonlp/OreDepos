...
public class ODOreFeature extends Feature<ODOreConfiguration> {
    public ODOreFeature(Codec<ODOreConfiguration> p_66531_) {
        super(p_66531_);
    }

    public boolean place(FeaturePlaceContext<ODOreConfiguration> p_160177_) {

...
public class CutterRecipeCategory implements IRecipeCategory<CutterRecipe> {
    ...
    public CutterRecipeCategory(IGuiHelper guiHelper) {
        ...
        this.icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM, new ItemStack(RegistryManager.CUTTER.get().asItem()));
        this.guiHelper = guiHelper;
    }

    @Override
    public ResourceLocation getUid() {
        return CutterRecipe.TYPE;
    }
    ...
    @Override
    public Class<? extends CutterRecipe> getRecipeClass() {
        return CutterRecipe.class;
    }

    @Override
    public Component getTitle() {
        return new TextComponent(RegistryManager.CUTTER.get().getName().getString());
    }
